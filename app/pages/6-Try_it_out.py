...
st.image('\\Users\\Coding\\Desktop\\Projects\\LipSyncer\\Images\\logo2.png')
...
def load_data(path: str): 
    ...
    file_name = os.path.splitext(os.path.basename(path))[0]  ## Windows
...
if options: 
    ...
    with col2: 
        ...
        st.image('\\Users\\Coding\\Desktop\\Projects\\LipSyncer\\Images\\animation.gif',use_column_width="always")
